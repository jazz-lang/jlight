...
impl TimeoutEntry {
    pub fn new(process: RcProcess, timeout: Arc<Timeout>) -> Self {
...
impl Timeouts {
    ...
    pub fn insert(&mut self, process: RcProcess, timeout: Arc<Timeout>) {
    ...
    pub fn processes_to_reschedule(&mut self) -> (Vec<RcProcess>, Option<Duration>) {
